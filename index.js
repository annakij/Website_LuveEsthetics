const products = [
    ...
    },
    {
      ...
      time: "30-45 minuter",
      price: "1 900 - 2 400",
      image: "images/icons8-team-y2T5hT7pWx4-unsplash.jpg",
      description:
    ...
    },
    {
      ...
      time: "60-70 minuter",
      price: "700 - 1 200",
      image: "images/sunny-ng-KVIlNRoGwxk-unsplash.jpg",
      description:
        "Brow och lash lift är skönhetsbehandlingar som ger dina ögonbryn och fransar en naturlig lyft och böjning. Behandlingarna förbättrar både form och volym, vilket ger ett fräschare och mer öppet uttryck utan behov av smink. Resultatet varar i flera veckor och ger ett hållbart, vackert resultat.",
    },
  ];
